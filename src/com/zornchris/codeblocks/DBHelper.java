...
public class DBHelper {
    ...
    public DBHelper(MOCDBLib dbPlugin, CodeBlocksPlugin plugin) {
        ...
        boolean eventExist = dbc.ensureTable(EVENT_TABLE, "id int NOT NULL AUTO_INCREMENT, pId int, event_type varchar(50), event_time timestamp, PRIMARY KEY (id)");
        
        //System.out.println(playerExist + " " + eventExist);
    }
    
    public void logEvent(String playerName, String eventType) {
        ...
        try {
            ...
            PreparedStatement ps = dbc.prepareStatement("INSERT INTO " + EVENT_TABLE + " (pId, event_type, event_time) VALUES(" + pId + ", '" + eventType + "', CURRENT_TIMESTAMP)");
            dbc.insertQuery(ps);
